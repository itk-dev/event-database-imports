 ...
 */
final class Version20230630095439 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE daily_occurrence (id INT AUTO_INCREMENT NOT NULL, event_id INT NOT NULL, occurrence_id INT NOT NULL, location_id INT NOT NULL, start DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', end DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', ticket_price_range VARCHAR(255) NOT NULL, room VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, INDEX IDX_431E7C9071F7E88B (event_id), INDEX IDX_431E7C9030572FAC (occurrence_id), INDEX IDX_431E7C9064D218E (location_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, organization_id INT DEFAULT NULL, feed_id INT DEFAULT NULL, excerpt VARCHAR(255) DEFAULT NULL, description LONGTEXT NOT NULL, image VARCHAR(255) DEFAULT NULL, url VARCHAR(255) NOT NULL, langcode VARCHAR(32) DEFAULT NULL, ticket_url VARCHAR(255) DEFAULT NULL, public TINYINT(1) NOT NULL, feed_item_id VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, created_by VARCHAR(255) DEFAULT NULL, updated_by VARCHAR(255) DEFAULT NULL, INDEX IDX_3BAE0AA732C8A3DE (organization_id), INDEX IDX_3BAE0AA751A5BC03 (feed_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE occurrence (id INT AUTO_INCREMENT NOT NULL, event_id INT NOT NULL, location_id INT NOT NULL, start DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', end DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', ticket_price_range VARCHAR(255) NOT NULL, room VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, INDEX IDX_BEFD81F371F7E88B (event_id), INDEX IDX_BEFD81F364D218E (location_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE daily_occurrence ADD CONSTRAINT FK_431E7C9064D218E FOREIGN KEY (location_id) REFERENCES location (id)');
        ...
        $this->addSql('ALTER TABLE occurrence ADD CONSTRAINT FK_BEFD81F364D218E FOREIGN KEY (location_id) REFERENCES location (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE daily_occurrence DROP FOREIGN KEY FK_431E7C9064D218E');
        ...
        $this->addSql('ALTER TABLE occurrence DROP FOREIGN KEY FK_BEFD81F364D218E');
