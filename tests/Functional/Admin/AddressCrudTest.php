...
final class AddressCrudTest extends AbstractAdminTestCase
{
    ...
    public function testIndexLoadsForEditor(): void
    {
        ...
        $this->client->request('GET', $this->adminUrl(AddressCrudController::class));
    ...
    {
        $this->loginAs(TestUserFixtures::EDITOR_EMAIL);
        $this->client->request('GET', $this->adminUrl(AddressCrudController::class, Action::NEW));
